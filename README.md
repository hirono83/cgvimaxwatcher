...
CGV 용산아이파크몰 IMAX관의 2026년 8월 18일~23일 상영 회차를 한국시간 06:07~23:07 사이 매시간 확인합니다. 새 회차를 처음 발견하면 텔레그램으로 알리고, 중복 알림 상태는 state.json에 자동 저장합니다.
...
- 한국시간 06:07~23:07, 매시간
- GitHub Actions 혼잡이 많은 정각을 피해 매시 7분에 실행
